...
жизненный цикл предложения (фиксированный вес голоса, дедлайн, отмена),
двухшаговая передача ownership, кэш Activity-скана, экономика v2 (возврат тела,
списание убытков, выход партнёра), контейнерный E2E и очередь расширений
(токенизация долей, стейблкоин, milestone-транши, шариатский совет, индексер,
...
разрывы (fee менеджера от выручки, распределение без восстановления капитала,
отсутствие учёта убытков и выхода партнёра) закрываются разделом
«Экономика v2» плана.
